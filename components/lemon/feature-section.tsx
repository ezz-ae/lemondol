...
import { ShoppingBag, Sparkles, Smile, Zap } from "lucide-react"

const features = [
  {
    icon: ShoppingBag,
    title: "Curated Style",
    description: "Only the freshest picks for you"
  },
  {
    icon: Sparkles,
    title: "Vibrant Quality",
    description: "High standards, bright results"
  },
  {
    icon: Smile,
    title: "Affordable Joy",
    description: "Budget-friendly happy shopping"
  },
  {
    icon: Zap,
    title: "Fast Discovery",
    description: "Find your new favorites instantly"
  }
]
    ...
    <section className="py-24 bg-background">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          {/* Video */}
          <div 
            className={`relative aspect-[4/5] rounded-3xl overflow-hidden lemon-shadow transition-all duration-700 ease-out ${
          ...
          >
            ...
            <p className={`text-lg text-muted-foreground leading-relaxed mb-10 max-w-md ${headerVisible ? 'animate-blur-in opacity-0' : 'opacity-0'}`} style={headerVisible ? { animationDelay: '0.6s', animationFillMode: 'forwards' } : {}}>
              We believe fashion should be a fresh experience, not just a purchase. 
              Every piece is curated with intention and love for your unique vibe.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {features.map((feature) => (
                <div
                  key={feature.title}
                  className="group p-5 lemon-transition hover:scale-[1.02] rounded-md bg-white"
                >
                  <div className="inline-flex items-center justify-center w-10 h-10 rounded-full mb-3 group-hover:bg-primary/20 lemon-transition bg-stone-50">
