...
const testimonials = [
  {
    ...
    location: "New York",
    rating: 5,
    text: "Lemondol has the cutest dresses! The quality is amazing for the price, and I always get so many compliments.",
    product: "Sunshine Lemon Dress"
  },
  {
    id: 2,
    name: "Emma L.",
    ...
    rating: 5,
    text: "Finally, a store that feels fresh and fun. The AI Studio helped me pick the perfect accessories for my graduation.",
    product: "Citrus Canvas Tote"
  },
  {
    id: 3,
    name: "Jessica R.",
    location: "Chicago",
    rating: 5,
    text: "The Lemon Zest Candle is absolutely divine. It smells like a summer morning and makes my room feel so bright.",
    product: "Lemon Zest Candle"
  },
  {
    id: 4,
    name: "Maria K.",
    location: "Miami",
    rating: 5,
    text: "I love the 'Deep Store' collection. It's so hard to find high-quality wellness items that are also stylish. Lemondol nailed it.",
    product: "Silk Wellness Set"
  },
  {
    id: 5,
    name: "Sophie T.",
    location: "Seattle",
    rating: 5,
    text: "Fast shipping and the packaging was so cute! You can tell they really care about the 'vibrant' girl experience.",
    product: "Spring Meadow Hat"
  },
  {
    id: 6,
    name: "Anna P.",
    location: "Boston",
    rating: 5,
    text: "My new favorite store. Affordable prices without sacrificing the high-end boutique feel. 10/10 recommended!",
    product: "Lemon Squeeze Tee"
  },
  {
    id: 7,
    name: "Claire B.",
    location: "Austin",
    rating: 5,
    text: "The texture of the silk pillowcase is perfection. It feels so luxurious and has improved my sleep routine.",
    product: "Silk Set"
  },
  {
    id: 8,
    ...
    location: "Portland",
    rating: 5,
    text: "I love that Lemondol focuses on high quality at affordable prices. It's rare to find such a curated selection.",
    product: "Zest Sneakers"
  },
  {
    id: 9,
    name: "Rachel D.",
    location: "Denver",
    rating: 5,
    text: "The whole vibe of the site is so inviting. Shopping here is truly an experience, not just a transaction.",
